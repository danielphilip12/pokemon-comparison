<template>
  <div>
    <h1 class="h2 text-center">Moves</h1>
    <small class="text-muted">Information from Generation Pokemon first appeared</small>
...
export default {
  ...
  computed: {
    sorted_moves: function() {
      ...
      moves_clone = moves_clone.sort((a, b) =>
        a.version_group_details[0].level_learned_at >
        b.version_group_details[0].level_learned_at
          ? 1
          : -1
      );
      return moves_clone.filter(
